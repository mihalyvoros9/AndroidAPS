...
class DetermineBasalAdapterSMBJS internal constructor(private val scriptReader: ScriptReader, private val injector: HasAndroidInjector) : DetermineBasalAdapter {
    ...
    override fun setData(
        ...
        this.profile.put("high_temptarget_raises_sensitivity", sp.getBoolean("high_temptarget_raises_sensitivity", SMBDefaults.high_temptarget_raises_sensitivity))
        this.profile.put("low_temptarget_lowers_sensitivity", sp.getBoolean("low_temptarget_lowers_sensitivity", SMBDefaults.low_temptarget_lowers_sensitivity))
        ...
        this.profile.put("exercise_mode", sp.getBoolean("high_temptarget_raises_sensitivity", SMBDefaults.high_temptarget_raises_sensitivity))
        ...
        this.profile.put("autoISF_version", 1)
